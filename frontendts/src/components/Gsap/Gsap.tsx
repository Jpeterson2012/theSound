...
export default function Gsap(){
    ...
    document.querySelector(".next") && document.querySelector(".next")!.addEventListener("click", () => scrubTo(scrub.vars.totalTime + spacing));
    document.querySelector(".prev") && document.querySelector(".prev")!.addEventListener("click", () => scrubTo(scrub.vars.totalTime - spacing));
